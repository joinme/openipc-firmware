...
define NIGHT_WATCHDOG_INSTALL_TARGET_CMDS
	# 安装脚本到 /usr/bin
	$(INSTALL) -D -m 0755 $(@D)/night-watchdog/src/night_watchdog.sh $(TARGET_DIR)/usr/bin/night_watchdog.sh
	# 安装启动脚本到 /etc/init.d
	$(INSTALL) -D -m 0755 $(@D)/night-watchdog/src/S99night $(TARGET_DIR)/etc/init.d/S99night
endef
